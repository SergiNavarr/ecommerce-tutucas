...
export const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between p-4 mx-auto cursor-pointer sm:max-w-4xl md:max-w-6xl">
            <h1 className="text-3xl" onClick={() => router.push("/")}>Tutuca´s</h1>
            <div className="items-center justufy-betwwen hidden sm:flex">
                <MenuList />
            </div>
            <div className="flex sm:hidden">
                <ItemsMenuMobile />
            </div>
            <div className="flex items-center justufy-between gap-2 sm:gap-7">
                {cart.items.length === 0 ? 
